...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	override function update(elapsed:Float)
	{
		...
		{
			if (FlxG.keys.pressed.SHIFT || key_shift.justPressed)
			{
		...
		/* if (FlxG.keys.justPressed.UP)
			...
			if (FlxG.keys.justPressed.RIGHT || FlxG.keys.justPressed.D #if android || _virtualpad.buttonRight.justPressed #end)
				changeSection(curSection + shiftThing);
			if (FlxG.keys.justPressed.LEFT || FlxG.keys.justPressed.A #if android || _virtualpad.buttonLeft.justPressed #end)
			changeSection(curSection - shiftThing);
