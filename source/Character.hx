...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
        ...
        var tex2 = Paths.getSparrowAtlas('characters/GF_assets_week2');
        var tex3 = Paths.getSparrowAtlas('characters/GF_assets_tutorial');
        var tex4 = Paths.getSparrowAtlas('characters/GF_assets_blowing');
        var tex5 = Paths.getSparrowAtlas('characters/GF_ass_sets_landing');
        
        tex = jointex(tex, jointex(tex2, jointex(tex3, jointex(tex4, tex5))));
...
frames = tex;
			...
			case 'gf-christmas':
				...
				tex = jointex(tex, Paths.getSparrowAtlas('characters/gfChristmas_em'));
			...
			case 'gf-tankmen':
				...
				tex = jointex(tex, Paths.getSparrowAtlas('characters/gfTankmen2'));
		...
		var tex2 = Paths.getSparrowAtlas('characters/BoyFriend_Assets_Dies');
		var tex3 = Paths.getSparrowAtlas('characters/BoyFriend_Assets_Loop_Confirm');
			...
			case 'bf-holding-gf-dead':
				...
				tex = Paths.getSparrowAtlas('characters/bfHoldingGF-DEAD');
				tex = jointex(tex, Paths.getSparrowAtlas('characters/bfHoldingGF-DEADL'));
				frames = tex;
		...
		var tex = Paths.getSparrowAtlas('characters/mom_dad_christmas_idle');
        var tex2 = Paths.getSparrowAtlas('characters/parents_dad_down');
        var tex3 = Paths.getSparrowAtlas('characters/parents_dad_left');
        var tex4 = Paths.getSparrowAtlas('characters/parents_dad_up');
        var tex5 = Paths.getSparrowAtlas('characters/parents_dadmom_right');
        var tex6 = Paths.getSparrowAtlas('characters/parents_mom_down');
        var tex7 = Paths.getSparrowAtlas('characters/parents_mom_left');
        var tex8 = Paths.getSparrowAtlas('characters/parents_mom_up');
